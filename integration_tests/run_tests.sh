...
if [ -z "$ES_NODE_STORAGE_L1CONTRACT_KZG" ]; then
  export ES_NODE_STORAGE_L1CONTRACT_KZG=0x76d03a6441bbC29eC664dA5083a915B1817c322C
fi
...
if [ -z "$ES_NODE_STORAGE_L1CONTRACT" ]; then
  export ES_NODE_STORAGE_L1CONTRACT=0x76d03a6441bbC29eC664dA5083a915B1817c322C
fi
