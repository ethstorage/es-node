...
zkey_url="https://drive.usercontent.google.com/download?id=V3QkMpk5UC48Jc62nHXMgzeMb6KE8JRY&export=download&confirm=t&uuid=987dbfe5-0dea-4c5b-8e8e-e03c0c43e5d2"
if [ "$zkp_mode" = 1 ]; then
