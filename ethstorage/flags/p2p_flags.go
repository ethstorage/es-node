...
var (
	...
	// Test flags
	TestSimpleSyncStartFlag = cli.Uint64Flag{
		Name:     "p2p.test.simple-sync.start",
		Usage:    "Start of simple sync",
		Required: false,
		Value:    0,
		EnvVar:   p2pEnv("TEST_SIMPLE_SYNC_START"),
	}
...
var p2pFlags = []cli.Flag{
	...
	TestSimpleSyncStartFlag,
	TestSimpleSyncEndFlag,
}
