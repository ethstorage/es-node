...
func (p *Prepared) Discovery(log log.Logger, l1ChainID uint64, tcpPort uint16) (*enode.LocalNode, *discover.UDPv5, error) {
	if p.LocalNode != nil {
...
func (p *Prepared) ConfigureGossip(rollupCfg *rollup.EsConfig) []pubsub.Option {
