...
Considering the complexity of Solution 1, which requires modifications to multiple components of the es-node, including the downloader and sync processes, we have opted for Solution 2 as the final implementation.
