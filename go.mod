...
require (
	...
	github.com/crate-crypto/go-proto-danksharding-crypto v0.0.0-20230312204821-9a244123c812
...
replace github.com/ethereum/go-ethereum v1.13.5 => github.com/ethereum-optimism/op-geth v1.101305.3
